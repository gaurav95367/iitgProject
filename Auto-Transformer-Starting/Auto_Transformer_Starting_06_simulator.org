...
* Objective
  - To check Simulator of the   Auto Transformer Starting experiment
...
* Expected result
  ...
  2. User should be redirected to 'http://vem-iitg.vlabs.ac.in/Auto%20Transformer%20Starting(experiment).html'
